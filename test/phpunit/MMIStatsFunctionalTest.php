...
/**
 * \file    test/phpunit/MMIStatsFunctionalTest.php
 * \ingroup mmistats
 ...
 *
 * @package Testmmistats
 */
class MMIStatsFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/mmistats/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('mmistats/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/mmistats/admin/about.php');
		$this->authenticate();
		return $this->assertContains('mmistats/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('mmistatswidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modMMIStats_MMIStatsTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modMMIStats_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
